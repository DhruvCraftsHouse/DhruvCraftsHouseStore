...
<div className="environment-div-style">
      ...
      <div className="text-center" style={backgroundStyle}>
        <Heading level="h1" className="mb-4 environment-heading" style={{ fontFamily: "Times New Roman,serif", fontStyle: "italic", fontWeight: 500, color: "white", textTransform: "uppercase" }}>
