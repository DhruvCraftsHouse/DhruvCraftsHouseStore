...
export const updatePassword = async (email: any, password: any) => {
  try {
    ...
    console.log('MEDUSA_BACKEND_URL verifypwd', process.env.NEXT_PUBLIC_MEDUSA_BACKEND_URL)
    // Make HTTP POST request
    const response = await axios.post(`${process.env.NEXT_PUBLIC_MEDUSA_BACKEND_URL}/store/updatepassword`, {
