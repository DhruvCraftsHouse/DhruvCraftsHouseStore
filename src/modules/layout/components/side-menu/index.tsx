      ...
      <div className="flex-grow overflow-y-auto p-4 flex space-x-8">
          ...
          <div className="space-y-2 flex-1" style={{fontFamily:"Avenir Next LT W02 Regular"}}>
            ...
            <ul className="" style={{fontSize:"10px", letterSpacing:"0.2em", textTransform:"uppercase", fontWeight: 500, lineHeight:"2.5em"}}>
                <li>Guarantees</li>
                <li>
                  <Link href="/customer-service#refundandcancellation"
                                     onClick={ ()=> {
                ...
                <li><Link href="/customer-service#shippinganddelivery"
                onClick={ ()=> {
                ...
                <li><Link href="/customer-service#contact"
 onClick={ ()=> {
  handleLinkClick('/customer-service#contact') 
 close();
}} 
                >Contact US </Link></li>
                <li><Link href="/customer-service#termsandconditions"
                 onClick={ ()=> {
                  handleLinkClick('/customer-service#termsandconditions')
                  close();
                } } 
                >Terms and Conditions</Link></li>
                <li style={{fontWeight:"bold",marginTop:"10%"}}><Link href="/customer-service#privacypolicy"
                                 onClick={ ()=> {
