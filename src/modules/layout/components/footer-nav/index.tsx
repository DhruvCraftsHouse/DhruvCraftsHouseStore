...
import { faChevronDown, faChevronUp } from '@fortawesome/free-solid-svg-icons'; // Import chevron icons for the dropdown
 ...
 const [showAboutCompany, setShowAboutCompany] = useState(false);
  ...
  return (
    ...
    <div className="border-t border-ui-border-base w-screen">
      ...
      <div className="flex flex-col gap-y-1 sm:gap-y-2 md:gap-y-4 xsmall:flex-row items-start justify-between py-10" style={{width:"88%", marginLeft:"3%",marginTop:"2%"}}>
...
>SPECIAL PROJECTS</Link></ul>
          ...
          <div className="" style={{fontSize: "10.5px", fontFamily:"Avenir Next LT W02 Regular",letterSpacing:"0.1em" }}>
            ...
            <ul className="list-none mt-3" style={{lineHeight:"3em", textTransform:"uppercase", fontSize:"8px"}}>
              {/* Replace with actual links or text */}
              <li ><Link className="option-li" href="/">GUARANTEES</Link></li>
              <li><Link href="/" className="option-li"
                         onClick={ ()=> handleLinkClick('/') } 
              >PAYMENT AND DELIVERY</Link></li>
              <li><Link className="option-li" href="/">FITTING</Link></li>
              <li><Link className="option-li" href="/">CERTIFICATION</Link></li>
              <li><Link className="option-li" href="/">PERSONALIZATION</Link></li>
              ...
              <li><Link className="option-li" href="/">ASK A QUESTION</Link></li>
          ...
          <div className="" style={{fontSize: "10.5px", fontFamily:"Avenir Next LT W02 Regular",letterSpacing:"0.1em" }}>
            ...
            <ul className="list-none mt-3" style={{lineHeight:"3em", textTransform:"uppercase", fontSize:"8px"}}>
              {/* Replace with actual links or text */}
              <li><Link className="option-li" href="/">ABOUT ALROSA</Link></li>
              <li><Link className="option-li" href="/">THE WAY OF THE DIAMOND</Link></li>
              <li><Link className="option-li" href="/">RUSSIAN CUT</Link></li>
              <li><Link className="option-li" href="/">KIMBERLEY PROCESS</Link></li>
              <li><Link className="option-li" href="/">SOCIAL RESPONSIBILITY</Link></li>
              <li><Link className="option-li" href="/">ENVIRONMENTAL RESPONSIBILITY</Link></li>
            </ul>
                  </div>
                  </div>
        ...
        <div className="dropdown-section">
          ...
          <div className="" style={{fontSize: "10.5px", fontFamily:"Avenir Next LT W02 Regular",letterSpacing:"0.1em" }}>
            <h3 className="option-list" style={{ fontWeight: "bold",fontSize:"10.5px"}}> <Link href="/customer-service#contact" onClick={ ()=> handleLinkClick('/customer-service#contact') }>CONTACTS</Link></h3>
