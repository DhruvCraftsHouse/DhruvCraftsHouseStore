             ...
             <div className="flex flex-col gap-y-4 ">
              ...
              {showForBuyersMenu && (
                <ul className="pl-4">
                  ...
                  <li><Link href="/customer-service#refundandcancellation" onClick={() => {
                    handleLinkClick(`/customer-service#refundandcancellation`)
                    close();
                  }}>REFUND AND CANCELLATION POLICY</Link></li>
                  <li><Link href="/customer-service#shippinganddelivery" onClick={() => {
                    handleLinkClick(`/customer-service#shippinganddelivery`)
                    close();
                  ...
                  <li><Link href="/customer-service#contact" onClick={() => {
                    handleLinkClick(`/customer-service#contact`)
                    close();
                  ...
                  <li><Link href="/customer-service#termsandconditions" onClick={() => {
                    handleLinkClick(`/customer-service#termsandconditions`)
                    close();
                  }}>TERMS AND CONDITIONS</Link></li>
                  <li><Link href="/customer-service#privacypolicy" onClick={() => {
                    handleLinkClick(`/customer-service#privacypolicy`)
                    close();
